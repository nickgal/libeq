...
impl Wld {
    ...
    pub fn meshes(&self) -> impl Iterator<Item = Mesh<'_>> + '_ {
        self.0
    ...
    pub fn materials(&self) -> impl Iterator<Item = Material<'_>> + '_ {
        self.0
    ...
    pub fn objects(&self) -> impl Iterator<Item = ObjectLocation<'_>> + '_ {
        self.0
            .fragment_iter::<Actor>()
    ...
    /// Iterate over all the objects in the wld file.
    pub fn models(&self) -> impl Iterator<Item = Model<'_>> + '_ {
        self.0
